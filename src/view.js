export default class View {
  ...
  _renderBorder() {
    ...
    this.context.lineWidth = this.playfieldBoderWidth;
  ...
  _renderPlayfield({ playfield, activePiece }) {
    ...
    this._renderPiece(activePiece, {
      x: this.playfieldX + activePiece.x * this.blockWidth,
      y: this.playfieldY + activePiece.y * this.blockHeight,
      width: this.blockWidth,
      height: this.blockHeight,
      color: View.colors[activePiece.type],
    });
  }
